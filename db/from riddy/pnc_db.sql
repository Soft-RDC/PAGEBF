...
--
-- Client: localhost
-- Généré le: Dim 05 Janvier 2014 à 17:49
...
--
-- Base de données: `pnc_db`
--
CREATE DATABASE IF NOT EXISTS `pnc_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `pnc_db`;

-- --------------------------------------------------------

--
-- Structure de la table `t_access`
--
...
--
-- Structure de la table `t_arbitration`
--
...
--
-- Structure de la table `t_besoins`
--
...
--
-- Structure de la table `t_budget1`
--
...
--
-- Structure de la table `t_budget1_expressions`
--
...
--
-- Structure de la table `t_budget2`
--
...
--
-- Structure de la table `t_budget2_expressions`
--
...
--
-- Structure de la table `t_budgetary_year`
--
...
--
-- Structure de la table `t_elaboration_budget1`
--
...
--
-- Structure de la table `t_expressions`
--
...
--
-- Structure de la table `t_manipulate`
--
...
--
-- Structure de la table `t_referee`
--
...
--
-- Structure de la table `t_submodule`
--
...
--
-- Contenu de la table `t_submodule`
--
...
(12, 9, 'Importer', '', 'ui-icon-arrowthickstop-1-s'),
(13, 9, 'Exporter', '', 'ui-icon-arrowthickstop-1-n');

-- --------------------------------------------------------

--
-- Structure de la table `t_unites`
--
...
CREATE TABLE IF NOT EXISTS `t_unites` (
  ...
  PRIMARY KEY (`id`),
  KEY `unite_id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='les unites sont: les grandes ecoles, les bureau de comgen et les sites provinciaux' AUTO_INCREMENT=3 ;

--
-- Contenu de la table `t_unites`
--

INSERT INTO `t_unites` (`id`, `unitname`) VALUES
(1, 'Ecole superieure'),
(2, 'Mumba');
...
(1, 1, 'ADA1312DFAS3423', 'Bob', 'Boseko', 'Bokanga', '+243814520766', 'bobnoblesse@gmail.com', 'Software developer', '', 'bboseko', 'bokanga', '2013-09-11 06:11:31', '2014-01-05 15:50:45', 0, 1, 0),
...
--
-- Contraintes pour la table `t_access`
--
...
--
-- Contraintes pour la table `t_arbitration`
--
...
--
-- Contraintes pour la table `t_besoins`
--
...
--
-- Contraintes pour la table `t_budget1`
--
...
--
-- Contraintes pour la table `t_budget1_expressions`
--
...
--
-- Contraintes pour la table `t_budget2`
--
...
--
-- Contraintes pour la table `t_budget2_expressions`
--
...
--
-- Contraintes pour la table `t_budgetary_year`
--
...
--
-- Contraintes pour la table `t_elaboration_budget1`
--
...
--
-- Contraintes pour la table `t_expressions`
--
...
--
-- Contraintes pour la table `t_manipulate`
--
...
--
-- Contraintes pour la table `t_referee`
--
...
--
-- Contraintes pour la table `t_submodule`
--
